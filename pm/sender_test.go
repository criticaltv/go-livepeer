...
func TestCreateTicketBatch_UsesSessionParamsInBatch(t *testing.T) {
	...
	// ExpectedExpirationParams sent by orchestrator
	ticketParams := TicketParams{
		...
		ExpectedExpirationParams: expectedExpParams,
	}
	sessionID := sender.StartSession(ticketParams)
	...
	assert.Equal(expectedExpParams, batch.ExpectedExpirationParams)
	// No ExpectedExpirationParams, get data from TimeManager
